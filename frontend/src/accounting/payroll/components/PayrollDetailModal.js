...
const PayrollDetailModal = ({ payroll, onClose }) => {
  ...
  const monthlyDeduction = payroll.deductions
    ? Math.floor(payroll.deductions / 12)
    : 0;
    ...
    <div className="payroll-modal-overlay">
      <div className="payroll-modal-container">
        <div className="payroll-modal-header">
          <h2>급여 상세 정보</h2>
          <button className="payroll-close-button" onClick={onClose}>
            X
          </button>
        </div>
