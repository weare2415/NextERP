...
export const getAnnouncementsByDepartment = async (departmentId) => {
    try {
        const response = await axiosInstance.get(`/api/announcements/department/${departmentId}`);
        return response.data;
    } catch (error) {
...
export const getAnnouncementsByPosition = async (positionId) => {
    try {
        const response = await axiosInstance.get(`/api/announcements/position/${positionId}`);
        return response.data;
    } catch (error) {
...
export const updateAnnouncement = async (id, updatedData) => {
    try {
        const response = await axiosInstance.put(`/api/announcements/${id}`, updatedData);
        return response.data;
    } catch (error) {
