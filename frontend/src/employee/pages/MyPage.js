...
} from "../../attendance/api/attendanceApi"; // ✅ 경로 수정
import BasicLayout from "../../common/pages/BasicLayout";
import "../../employee/scss/MyPage.scss";
      ...
      <div className="mypage">
        ...
        {loading ? (
          ...
          <div className="attendance-info">
            <p>
              <strong>출근 시간:</strong> {attendance.checkInTime || "출근 전"}
            </p>
            <p>
              <strong>퇴근 시간:</strong> {attendance.checkOutTime || "퇴근 전"}
            </p>
            <p>
              <strong>상태:</strong> {attendance.status}
            </p>
          </div>
        ) : (
          <p>📌 출근 기록이 없습니다.</p>
