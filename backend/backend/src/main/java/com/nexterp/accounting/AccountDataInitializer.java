    ...
    return args -> {
      ...
      if (firstPage.isEmpty()) {
        ...
        accountRepository.saveAll(List.of(
            ...
            new Account("140", "매도가능금융자산", AccountType.ASSET, asset, "매도가능금융자산 계정", BigDecimal.ZERO),
            new Account("150", "기타유동자산", AccountType.ASSET, asset, "기타유동자산 계정", BigDecimal.ZERO),
            new Account("160", "무형자산", AccountType.ASSET, asset, "무형자산 계정", BigDecimal.ZERO),
            new Account("170", "장기금융자산", AccountType.ASSET, asset, "장기금융자산 계정", BigDecimal.ZERO),
            new Account("180", "관계기업투자", AccountType.ASSET, asset, "관계기업투자 계정", BigDecimal.ZERO)
            ));
        ...
        accountRepository.saveAll(List.of(
            ...
            new Account("230", "단기미지급비용", AccountType.LIABILITY, liability, "단기미지급비용 계정", BigDecimal.ZERO),
            new Account("240", "단기충당부채", AccountType.LIABILITY, liability, "단기충당부채 계정", BigDecimal.ZERO),
            new Account("250", "퇴직급여충당부채", AccountType.LIABILITY, liability, "퇴직급여충당부채 계정", BigDecimal.ZERO),
            new Account("260", "이연법인세부채", AccountType.LIABILITY, liability, "이연법인세부채 계정", BigDecimal.ZERO)
            ));
        ...
        accountRepository.saveAll(List.of(
            ...
            new Account("320", "영업이익", AccountType.EQUITY, equity, "영업이익 계정", BigDecimal.ZERO),
        ...
        accountRepository.saveAll(List.of(
            ...
            new Account("520", "매출원가", AccountType.EXPENSE, expense, "매출원가 계정", BigDecimal.ZERO)
        ));
      }
    };
  }*/
